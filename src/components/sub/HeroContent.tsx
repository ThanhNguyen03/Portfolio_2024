    ...
    >
      <div className='h-full w-full flex flex-col gap-5 justify-center m-auto md:text-start text-center'>
        ...
        >
          ...
          <h1 className='Welcome-text text-sm font-semibold'>
            FrontEnd Developer Portfolio
          </h1>
        </motion.div>
        <motion.div
          className='flex flex-col gap-6 mt-6 text-6xl text-bold text-white max-w-[600px] w-auto h-auto leading-none'
        ...
        <motion.a
          className='py-2 px-8 button-primary text-center text-white cursor-pointer rounded-lg max-w-[200px] custom-max:mx-auto'
          href='#skills'
