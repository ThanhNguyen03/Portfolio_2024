    ...
    >
      <div className='mx-auto flex size-full max-w-[1200px] items-center justify-center gap-4 md:gap-6 lg:gap-10'>
        <div className='flex size-full flex-col items-center justify-center gap-4 text-center md:items-start md:gap-6 md:text-start'>
          ...
          >
            <SparkleIcon size={32} className='mr-3 size-6 text-pink-500/95 md:size-8' />
          ...
          >
            ...
            <br />
            <TypingText
              sequence={['Secure', 1000, 'Scalable', 1000, 'High-performance', 1000, 'User-centric', 1000]}
              speed={60}
              deletionSpeed={40}
              repeat={Infinity}
          ...
          <motion.p
            ...
            animate={isInitVideoEnded ? 'visible' : 'hidden'}
          >
            <strong className='text-primary-300'>Software Engineer</strong> with 2+ years of professional development
            experience in both <strong className='text-secondary-300'>Frontend</strong> &{' '}
            <strong className='text-pink-300'>Backend</strong>. <br />
            Have 1+ year of experience working with
            <br className='md:hidden' /> <strong className='text-violet-300'>Web3 technologies</strong>, and blockchain
            ecosystems
          </motion.p>
        </div>
        <motion.div
          ...
          animate={isInitVideoEnded ? 'visible' : 'hidden'}
        >
          <Image src={skill} alt='work icons' height={650} width={650} className='opacity-80' />
        </motion.div>
      </div>
    </motion.div>
  )
