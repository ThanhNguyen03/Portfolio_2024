    ...
    return (
        <div className='w-full h-[60px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50 px-10'>
            <div className='w-full h-full flex items-center md:justify-between justify-center m-auto px-3 '>
                <Link className='md:flex items-center h-auto w-auto hidden' href={'#about-me'}>
                    <div className='relative overflow-hidden w-full h-full rounded-full hover:animate-bounce'>
                        <Image src={'/wavata.PNG'} width={60} height={60} alt='logo' objectFit='fill' className=' cursor-pointer '/>
                    </div>
